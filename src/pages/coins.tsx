...
export default function Coins() {
  ...
  const topGainer =
    coins.length > 0
      ? coins.reduce((max, coin) =>
          ...
          (max.price_change_percentage_24h || 0)
            ? coin
            : max
        )
      : null;
  ...
  const topLoser =
    coins.length > 0
      ? coins.reduce((min, coin) =>
          (coin.price_change_percentage_24h || 0) <
          (min.price_change_percentage_24h || 0)
            ? coin
            : min
        )
      : null;
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 relative z-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-700 text-lg">
            Track the top 20 cryptocurrencies by market cap
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          {topLoser &&
            ...
            topLoser.price_change_percentage_24h < 0 && (
              <div className="relative group">
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  ...
                  <div className="flex items-center gap-5 flex-1 min-w-[250px]">
                    ...
                    <div className="relative">
                      <div
                        className={`absolute inset-0 border rounded-2xl blur-md transition-opacity ${
                  ...
                  <div className="flex items-center gap-4 md:gap-8">
                    <div className="text-right">
                      ...
                      {coin.price_change_percentage_24h !== undefined && (
                        <div
                          className={`flex items-center justify-end gap-2 px-3 py-1.5 rounded-xl font-semibold ${
                            coin.price_change_percentage_24h >= 0
